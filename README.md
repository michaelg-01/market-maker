...
*   **Dust Accumulation:** Small partial fills are accumulated in a queue. The sidecar is only triggered to fire the market order once the queued volume reaches a minimum threshold (`MIN_HEDGE_QTY`).
